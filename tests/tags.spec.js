...
describe('Tags Api endpoint', function () {
  ...
  it('Verifies a created tag in a Space and deletes it in ClickUp', async function() {
  ...
  it('Verifies a created tag in a Task and deletes it in ClickUp', async function() {
    const tagName = helper.generateID();
